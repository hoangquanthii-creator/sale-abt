...
import { X, Sparkles, Plus, CheckSquare, Calendar, User, Loader2, Tag } from 'lucide-react';
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ví dụ: Lập báo cáo doanh thu tháng..."
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-medium text-slate-700">Việc nhỏ (Subtasks)</label>
              <button
